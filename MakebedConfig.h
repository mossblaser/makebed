...
/* PID */
#define THERMISTOR_EXTRUDER_P 7.0
#define THERMISTOR_EXTRUDER_I 0.0
#define THERMISTOR_EXTRUDER_D 50.0

#define THERMISTOR_PLATFORM_P 7.0
#define THERMISTOR_PLATFORM_I 0.32421875
#define THERMISTOR_PLATFORM_D 36.0
