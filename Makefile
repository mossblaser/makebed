...
CFLAGS+=-I LPCUSB -I cutil -I GPIO -I analog -I stepper -I /home/jonathan/Programing/mbed/FreeRTOSv7.0.2/Demo/Common/include -I webserver
...
VPATH=${RTOS_SOURCE_DIR}:${RTOS_SOURCE_DIR}/portable/MemMang:${RTOS_SOURCE_DIR}/portable/GCC/ARM_CM3:$init:webserver:LPCUSB:GPIO:analog:stepper:cutil
