\chapter{Example Printing Workflow}
	...
	\section{Printing Process}
		...
		\subsection{Main Printing Phase}
			...
			Layers inside the model are filled with a hexagonal `fill pattern'. The
